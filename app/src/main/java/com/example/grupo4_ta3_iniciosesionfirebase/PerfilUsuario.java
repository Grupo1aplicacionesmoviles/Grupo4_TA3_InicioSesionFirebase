...
public class PerfilUsuario extends AppCompatActivity {
    ...
    public void cerrarSesion(View view){
        ...
        intent.putExtra("msg","ccerrarSesion");
    ...
    public void leerTweets(){
        db_reference.child("Grupo4").child("Tweets").addValueEventListener(new ValueEventListener(){
            @Override
    ...
    public void escribirTweets(String autor){
        ...
        String fecha = "6/17/2021";
        HashMap<String, String> hola_tweet = new HashMap<>();
